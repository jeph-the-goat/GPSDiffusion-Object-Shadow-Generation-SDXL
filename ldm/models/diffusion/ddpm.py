...
class DiffusionWrapper(pl.LightningModule):
    def __init__(self, diff_model_config, conditioning_key):
        ...
        pretrained_model_name_or_path = '/data/zhaohaonan/model/hugging_face/stable-diffusion-xl-base-1.0'
        ...
        # self.diffusion_model.scheduler = LCMScheduler.from_config(self.diffusion_model.scheduler.config)
        # self.diffusion_model.load_lora_weights("latent-consistency/lcm-lora-sdv1-5")
